...
sum_bivalves_3h_open_time_ratio_and_perc <- bivalves_3h_open_time_ratio_and_perc %>% 
  ...
  summarise_at(vars(open_time_ratio), funs(mean, median, sd, n())) %>% 
...
correlation_hitsogram <- ggplot(biv_corr_hour, aes(corr_values)) +
...
correlation_boxplot <- ggplot(biv_corr_hour, mapping =  
